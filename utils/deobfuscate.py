...
class Deobfuscator:
    ...
    def deobfuscate(content: str, package_name: str, version: str, file_name: str) -> None:
        ...
        synchronized_print(f"Find deobfuscated js file! For package {package_name} version {version}, file {file_name}. Starting try to deobfuscate...", target=OutputTarget.FILE_ONLY)
